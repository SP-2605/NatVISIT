		...
		<div class="book__form">
			...
			<?php include('errors.php'); ?>
				...
				<div class="form__group">
					<input type="text" class="form__input" id="name" placeholder="Full-Name" required name="username" value="<?php echo $username; ?>">
					<label for="name" class="form__lable">Full-Name</label>
				</div>

				<div class="form__group">
  	  				<input type="text" class="form__input" id="email" placeholder="Email-Id" required name="email" value="<?php echo $email; ?>">
					<label for="email" class="form__lable">Email-Id</label>
  				</div>


				<div class="form__group">
					<input type="password" class="form__input" id="password_1" placeholder="Enter-Password" required name="password_1">
					<label for="password_1" class="form__lable">Enter-Password</label>
				</div>

				<div class="form__group">
					<input type="password" class="form__input" id="password_2" placeholder="Re-Enter Password" required name="password_2">
					<label for="password_2" class="form__lable">Re-Enter Password</label>
				</div>

				<div class="form__group">
					<button type="submit" class="form__SignUpLoginBtn" name="reg_user"><h2 class="form__SignUpLoginBtn-Text">SignUp <img class="form__SignUpLoginBtn-arrow" src="img/arrow.png" alt="Img"></h2></button>
				</div>
				<p>
					Already a Member? <a href="login.php#booking">Login</a>
				</p>
